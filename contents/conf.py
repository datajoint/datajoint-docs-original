...
exclude_patterns = ['README.md', '_build', 'Thumbs.db', '.DS_Store', 'contents/*/*_lang[0-9].rst']
...
htmlhelp_basename = 'DataJointDocssdoc'
...
man_pages = [
    (master_doc, 'datajointdocs', 'DataJoint Docs',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DataJointDocs', 'DataJoint Docs',
     author, 'DataJointDocs', 'One line description of project.',
     'Miscellaneous'),
]
...
def setup(app):
    # Custom CSS
    app.add_stylesheet('css/dj_doc_theme.css')
    app.add_stylesheet('https://fonts.googleapis.com/css?family=Catamaran')
