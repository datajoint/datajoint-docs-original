...
All :doc:`../manipulation/Insert` and :doc:`../queries/2-fetch` operations work identically for ``external`` attributes as for blob attributes with the same serialization protocol.  
