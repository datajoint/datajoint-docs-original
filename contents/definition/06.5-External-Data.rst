...
.. note::
  ...
  delays in fetching large files. 

This only applies to external ``filepath`` fetches.
...
.. code-block:: python
    ...
    dj.config["filepath_checksum_size_limit"] = 1024**3 # This is 1GB so all files over that will not be checked
