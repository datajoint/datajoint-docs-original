...
> ⚠️ This repo is no longer maintained and has been superseded by [datajoint-company/datajoint-docs](https://github.com/datajoint-company/datajoint-docs). Please file new issues there (or help contribute!). We are currently migrating and generating new content until December 2022 after which we'll also be decomissioning https://docs.datajoint.org in favor of https://datajoint.com/docs/.
